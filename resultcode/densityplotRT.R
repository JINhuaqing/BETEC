...
# BETEC
f1 <- post.f.R(1, 16, 19, 75)
f2 <- post.f.R(1, 12, 17, 56)
f3 <- post.f.R(2, 12, 16, 39)
f4 <- post.f.R(4, 13, 13, 25)
f1s <- sapply(seq(0, 1, 0.01), f1)
f2s <- sapply(seq(0, 1, 0.01), f2)
f3s <- sapply(seq(0, 1, 0.01), f3)
f4s <- sapply(seq(0, 1, 0.01), f4)
f1s <- f1s / PR.f(1, 16, 19, 75)
f2s <- f2s / PR.f(1, 12, 17, 56)
f3s <- f3s / PR.f(2, 12, 16, 39)
f4s <- f4s / PR.f(4, 13, 13, 25)
jpeg(file="rBETEC.jpg")
plot(seq(0, 1, 0.01), f1s, type="l", lty=1, col="red", lwd=2, xlab="p", ylab="Density", ylim=c(0, 4.2), xaxt="n")
lines(seq(0, 1, 0.01), f2s, type="l", lty=2, col="blue", lwd=2)
lines(seq(0, 1, 0.01), f3s, type="l", lty=3, col="green", lwd=2)
lines(seq(0, 1, 0.01), f4s, type="l", lty=4, col="purple", lwd=2)
...
# delta-BETEC
f1 <- post.f.R(1, 16, 13, 51)
f2 <- post.f.R(1, 12, 17, 56)
f3 <- post.f.R(3, 17, 24, 59)
f4 <- post.f.R(7, 24, 28, 55)
f1s <- sapply(seq(0, 1, 0.01), f1)
f2s <- sapply(seq(0, 1, 0.01), f2)
f3s <- sapply(seq(0, 1, 0.01), f3)
f4s <- sapply(seq(0, 1, 0.01), f4)
f1s <- f1s / PR.f(1, 16, 13, 51)
f2s <- f2s / PR.f(1, 12, 17, 56)
f3s <- f3s / PR.f(3, 17, 24, 59)
f4s <- f4s / PR.f(7, 24, 28, 55)
jpeg(file="rdelta-BETEC.jpg")
plot(seq(0, 1, 0.01), f1s, type="l", lty=1, col="red", lwd=2, xlab="p", ylab="Density", ylim=c(0, 4.2), xaxt="n")
lines(seq(0, 1, 0.01), f2s, type="l", lty=2, col="blue", lwd=2)
lines(seq(0, 1, 0.01), f3s, type="l", lty=3, col="green", lwd=2)
lines(seq(0, 1, 0.01), f4s, type="l", lty=4, col="purple", lwd=2)
