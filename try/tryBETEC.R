...
option.list <- list(
    make_option("--p0", type="double", default=0.2, help="p0, default is 0.05"),
    make_option("--p1", type="double", default=0.35, help="p1"),
    make_option("--a1", type="double", default=0.002, help="a1"),
    make_option("--a2", type="double", default=0.07, help="a2"),
...
#res1 <- BETEC(p0, p1, pi1, pi2, a1, a2, alpha0=alpha0, beta0=beta0, nMax=200, N=opt$N);res1
...
res <- c(7, 37, 22, 62)
stats <- round(Combo.Results(res, p0, p1, N=200000), 6)
