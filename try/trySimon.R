...
option.list <- list(
    make_option("--p0", type="double", default=0.15, help="p0"),
    make_option("--p1", type="double", default=0.35, help="p1"),
    make_option("--typ1", type="double", default=8.67e-8, help="type I error"),
    make_option("--typ2", type="double", default=0.842, help="type II error")
                    )
