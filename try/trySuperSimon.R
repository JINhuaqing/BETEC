...
option.list <- list(
    ...
    make_option("--typ1", type="double", default=0.10, help="type I error"),
    make_option("--typ2", type="double", default=0.10, help="type II error")
                    )
...
res <- ph2simon(p1, p1+p1-p0, typ1, typ2, nmax=100)
print(res)
